...
const Search = () => {
  ...
  return (
    <section className="container px-4 my-16 grid gap-8 md:grid-cols-3">
      <div className="md:col-span-2  font-['Caveat'] text-xl">
        <h3 className="bg-black text-3xl inline-block text-transparent bg-clip-text uppercase font-extrabold mb-4">
          luxury included vacations
        </h3>
        <p className="mb-10 text-2xl text-gray-600 text-justify">
        ...
        <div className="flex flex-col sm:flex-row">
          <div className="text-center">
            <h4 className="bg-black text-2xl inline-block text-transparent bg-clip-text uppercase font-extrabold mb-2">Leading service</h4>
          ...
          <div className="text-center">
            <h4 className="bg-black text-2xl inline-block text-transparent bg-clip-text uppercase font-extrabold mb-2">Automated booking</h4>
            <p className="uppercase text-gray-600">
